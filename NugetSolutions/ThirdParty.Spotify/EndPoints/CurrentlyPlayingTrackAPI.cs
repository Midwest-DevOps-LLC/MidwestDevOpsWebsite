...
{
    public static class CurrentlyPlayingTrackAPI
    {
        public static Models.ApiResponse<MDO.RESTDataEntities.Standard.ThirdParty.Spotify.CurrentlyPlayingResponse> CurrentlyPlayingTrack(int userID)
        {
            var methodResponse = new Models.ApiResponse<MDO.RESTDataEntities.Standard.ThirdParty.Spotify.CurrentlyPlayingResponse>();
            ...
            try
            {
                ...
                RESTServiceRequestor.Standard.RestClient restClient = new RESTServiceRequestor.Standard.RestClient("https://api.spotify.com/v1/me/player/currently-playing");
                ...
                var deserialized = JsonConvert.DeserializeObject<MDO.RESTDataEntities.Standard.ThirdParty.Spotify.CurrentlyPlayingResponse>(response);
