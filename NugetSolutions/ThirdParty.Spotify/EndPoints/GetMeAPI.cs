...
{
    public static class GetMeAPI
    {
        public static Models.ApiResponse<MDO.RESTDataEntities.Standard.ThirdParty.Spotify.GetMeResponse> GetMe(int userID)
        {
            var methodResponse = new Models.ApiResponse<MDO.RESTDataEntities.Standard.ThirdParty.Spotify.GetMeResponse>();
            ...
            try
            {
                ...
                RESTServiceRequestor.Standard.RestClient restClient = new RESTServiceRequestor.Standard.RestClient("https://api.spotify.com/v1/me");
                ...
                var deserialized = JsonConvert.DeserializeObject<MDO.RESTDataEntities.Standard.ThirdParty.Spotify.GetMeResponse>(response);
