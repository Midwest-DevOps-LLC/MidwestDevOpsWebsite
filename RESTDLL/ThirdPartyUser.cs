...
namespace RESTDLL
{
    public class ThirdPartyUser : DBManager
    {
        ...
        {
            List<MDO.RESTDataEntities.Standard.ThirdPartyUser> p = new List<MDO.RESTDataEntities.Standard.ThirdPartyUser>();
        ...
        public MDO.RESTDataEntities.Standard.ThirdPartyUser GetThirdPartyUserByID(int thirdPartyUserID)
        {
            MDO.RESTDataEntities.Standard.ThirdPartyUser person = new MDO.RESTDataEntities.Standard.ThirdPartyUser();
        ...
        public long? SaveThirdPartyUser(MDO.RESTDataEntities.Standard.ThirdPartyUser p)
        {
            using (MySqlConnection conn = GetConnection())
            {
                conn.Open();
        ...
        internal MDO.RESTDataEntities.Standard.ThirdPartyUser ConvertMySQLToEntity(MySqlDataReader reader)
        {
            MDO.RESTDataEntities.Standard.ThirdPartyUser p = new MDO.RESTDataEntities.Standard.ThirdPartyUser();
